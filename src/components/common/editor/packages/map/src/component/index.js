import { $, Card, CardType, isEngine } from "@aomao/engine"
import autosize from "autosize"
import "./index.less"

class MapComponent extends Card {
  static get cardName() {
    return "map"
  }
    ...
    return items.concat([
      {
        ...
        title: language.get("map", "displayBlockTitle"),
        onClick: () => {
  ...
  render() {
    ...
    const container =
      this.type === CardType.BLOCK
        ...
        : $(`<span class="map-container-inline"><a>
    ...
    autosize(textarea.get())
    textarea.on("input", () => {
      this.setValue({
        title: textarea.get()?.value
      })
    })
