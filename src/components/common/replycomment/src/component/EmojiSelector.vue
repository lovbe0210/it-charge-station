<template>
  <div class="emoji-selector">
    ...
    <div ref="scrollbarRef" style="padding: 10px" class="emoji-list-scroll">
      <div class="emoji-body">
          <div class="emjio-container" >
            <div v-for="(item, index) in emojis" :key="index" class="emoji-wrapper">
                <span class="emoji-item" @click="addEmoji(index)">
                      <b-img class="emoji"
                             :src="item"
                             :title="index"
                             right
...
<style scoped lang="less">
  .emoji-selector {
    ...
    .emoji-list-scroll:hover::-webkit-scrollbar {
      width: 7px;
      /*height: 30px;*/
      border-radius: 4px;
    }

    .emoji-list-scroll:hover::-webkit-scrollbar-thumb {
      /*height: 30px;*/
      border-radius: 4px;
      background-color: rgba(144, 147, 153, 0.5); /* 自定义滚动条滑块颜色 */
    }
  }
