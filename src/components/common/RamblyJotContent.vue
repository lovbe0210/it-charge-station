...
import {ramblyPlugins, pluginConfig} from "@/components/common/editor/config"
        ...
        if (data?.result) {
          ...
          if (_data != null) {
            ...
            if (_data.content?.length !== 0) {
              view.render(_data.content, true)
            }
          }
        }
      })*/

      view.render(this.rambly.content, true)
      this.view = view;
    }
  }
}
