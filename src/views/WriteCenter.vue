<template>
  <div :class="['editor-center', docStyle.customerTheme ? 'enable-background' : 'normal-background']" ref="TooltipContainer">
          ...
          <div class="category">
            ...
            <div class="category-group">
              ...
              <Select v-model="docInfo.secondLevel"
                      ...
                      placeholder="选择二级分类"
                      class="second-level">
                <Option v-for="item in secondLevelList" :value="item.code" :key="item.uid">{{ item.menuName }}</Option>
              </Select>
            </div>
          </div>
          <div class="tags">
            ...
            <div class="tag-add-control">
              <template v-for="(tag, index) in docInfo.tags">
